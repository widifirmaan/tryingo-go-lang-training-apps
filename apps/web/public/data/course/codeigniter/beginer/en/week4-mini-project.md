...
1. Understand and apply **mini project: first application** concepts in CodeIgniter 4 PHP Web Framework
...
- **What is mini project: first application** — Definition and importance in CodeIgniter 4 PHP Web Framework
...
```
// CodeIgniter 4 PHP Web Framework — Mini Project: First Application
...
This week we learned about **mini project: first application** in CodeIgniter 4 PHP Web Framework.

### Key Points:
1. Mini Project: First Application is an important foundation in CodeIgniter 4 PHP Web Framework
