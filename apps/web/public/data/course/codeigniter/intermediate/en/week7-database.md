...
1. Understand and apply **database & storage** concepts in CodeIgniter 4 PHP Web Framework
...
- **What is database & storage** — Definition and importance in CodeIgniter 4 PHP Web Framework
...
```
// CodeIgniter 4 PHP Web Framework — Database & Storage
...
This week we learned about **database & storage** in CodeIgniter 4 PHP Web Framework.

### Key Points:
1. Database & Storage is an important foundation in CodeIgniter 4 PHP Web Framework
