...
1. Understand and apply **deployment & ci/cd** concepts in C# & .NET 8 Web API Services
...
- **What is deployment & ci/cd** — Definition and importance in C# & .NET 8 Web API Services
...
This week we learned about **deployment & ci/cd** in C# & .NET 8 Web API Services.

### Key Points:
1. Deployment & CI/CD is an important foundation in C# & .NET 8 Web API Services
