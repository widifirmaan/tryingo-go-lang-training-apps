...
1. Understand and apply **application security** concepts in Docker Containers & Cloud DevOps
...
- **What is application security** — Definition and importance in Docker Containers & Cloud DevOps
...
```
// Docker Containers & Cloud DevOps — Application Security
...
This week we learned about **application security** in Docker Containers & Cloud DevOps.

### Key Points:
1. Application Security is an important foundation in Docker Containers & Cloud DevOps
