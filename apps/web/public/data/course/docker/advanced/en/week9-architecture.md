...
1. Understand and apply **architecture & patterns** concepts in Docker Containers & Cloud DevOps
...
- **What is architecture & patterns** — Definition and importance in Docker Containers & Cloud DevOps
...
```
// Docker Containers & Cloud DevOps — Architecture & Patterns
...
This week we learned about **architecture & patterns** in Docker Containers & Cloud DevOps.

### Key Points:
1. Architecture & Patterns is an important foundation in Docker Containers & Cloud DevOps
