...
1. Memahami dan menerapkan konsep **deployment & ci/cd** dalam Docker Containers & Cloud DevOps
...
- **Apa itu deployment & ci/cd** — Definisi dan pentingnya dalam Docker Containers & Cloud DevOps
...
```
// Docker Containers & Cloud DevOps — Deployment & CI/CD
...
Minggu ini kita telah mempelajari **deployment & ci/cd** dalam Docker Containers & Cloud DevOps.

### Poin Penting:
1. Deployment & CI/CD adalah fondasi penting dalam Docker Containers & Cloud DevOps
