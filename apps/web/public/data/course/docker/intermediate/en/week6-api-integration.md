...
1. Understand and apply **api & integration** concepts in Docker Containers & Cloud DevOps
...
- **What is api & integration** — Definition and importance in Docker Containers & Cloud DevOps
...
```
// Docker Containers & Cloud DevOps — API & Integration
...
This week we learned about **api & integration** in Docker Containers & Cloud DevOps.

### Key Points:
1. API & Integration is an important foundation in Docker Containers & Cloud DevOps
