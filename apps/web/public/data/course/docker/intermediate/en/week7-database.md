...
1. Understand and apply **database & storage** concepts in Docker Containers & Cloud DevOps
...
- **What is database & storage** — Definition and importance in Docker Containers & Cloud DevOps
...
```
// Docker Containers & Cloud DevOps — Database & Storage
...
This week we learned about **database & storage** in Docker Containers & Cloud DevOps.

### Key Points:
1. Database & Storage is an important foundation in Docker Containers & Cloud DevOps
