...
1. Understand and apply **microservices & scalability** concepts in Docker Containers & Cloud DevOps
...
- **What is microservices & scalability** — Definition and importance in Docker Containers & Cloud DevOps
...
```
// Docker Containers & Cloud DevOps — Microservices & Scalability
...
This week we learned about **microservices & scalability** in Docker Containers & Cloud DevOps.

### Key Points:
1. Microservices & Scalability is an important foundation in Docker Containers & Cloud DevOps
