...
1. Understand and apply **application security** concepts in Golang Concurrent Microservices
...
- **What is application security** — Definition and importance in Golang Concurrent Microservices
...
```
// Golang Concurrent Microservices — Application Security
...
This week we learned about **application security** in Golang Concurrent Microservices.

### Key Points:
1. Application Security is an important foundation in Golang Concurrent Microservices
