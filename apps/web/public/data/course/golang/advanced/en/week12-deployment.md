...
1. Understand and apply **deployment & ci/cd** concepts in Golang Concurrent Microservices
...
- **What is deployment & ci/cd** — Definition and importance in Golang Concurrent Microservices
...
This week we learned about **deployment & ci/cd** in Golang Concurrent Microservices.

### Key Points:
1. Deployment & CI/CD is an important foundation in Golang Concurrent Microservices
