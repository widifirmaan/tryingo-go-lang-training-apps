...
1. Understand and apply **architecture & patterns** concepts in Golang Concurrent Microservices
...
- **What is architecture & patterns** — Definition and importance in Golang Concurrent Microservices
...
```
// Golang Concurrent Microservices — Architecture & Patterns
...
This week we learned about **architecture & patterns** in Golang Concurrent Microservices.

### Key Points:
1. Architecture & Patterns is an important foundation in Golang Concurrent Microservices
