...
1. Understand and apply **api & integration** concepts in Golang Concurrent Microservices
...
- **What is api & integration** — Definition and importance in Golang Concurrent Microservices
...
```
// Golang Concurrent Microservices — API & Integration
...
This week we learned about **api & integration** in Golang Concurrent Microservices.

### Key Points:
1. API & Integration is an important foundation in Golang Concurrent Microservices
