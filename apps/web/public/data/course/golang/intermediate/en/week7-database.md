...
1. Understand and apply **database & storage** concepts in Golang Concurrent Microservices
...
- **What is database & storage** — Definition and importance in Golang Concurrent Microservices
...
```
// Golang Concurrent Microservices — Database & Storage
...
This week we learned about **database & storage** in Golang Concurrent Microservices.

### Key Points:
1. Database & Storage is an important foundation in Golang Concurrent Microservices
