...
1. Understand and apply **microservices & scalability** concepts in Golang Concurrent Microservices
...
- **What is microservices & scalability** — Definition and importance in Golang Concurrent Microservices
...
```
// Golang Concurrent Microservices — Microservices & Scalability
...
This week we learned about **microservices & scalability** in Golang Concurrent Microservices.

### Key Points:
1. Microservices & Scalability is an important foundation in Golang Concurrent Microservices
