...
1. Understand and apply **application security** concepts in GraphQL & Modern API Gateway
...
- **What is application security** — Definition and importance in GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Application Security
...
This week we learned about **application security** in GraphQL & Modern API Gateway.

### Key Points:
1. Application Security is an important foundation in GraphQL & Modern API Gateway
