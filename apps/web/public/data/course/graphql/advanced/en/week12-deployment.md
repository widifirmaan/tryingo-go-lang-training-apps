...
1. Understand and apply **deployment & ci/cd** concepts in GraphQL & Modern API Gateway
...
- **What is deployment & ci/cd** — Definition and importance in GraphQL & Modern API Gateway
...
This week we learned about **deployment & ci/cd** in GraphQL & Modern API Gateway.

### Key Points:
1. Deployment & CI/CD is an important foundation in GraphQL & Modern API Gateway
