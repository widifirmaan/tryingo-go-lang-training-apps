...
1. Understand and apply **architecture & patterns** concepts in GraphQL & Modern API Gateway
...
- **What is architecture & patterns** — Definition and importance in GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Architecture & Patterns
...
This week we learned about **architecture & patterns** in GraphQL & Modern API Gateway.

### Key Points:
1. Architecture & Patterns is an important foundation in GraphQL & Modern API Gateway
