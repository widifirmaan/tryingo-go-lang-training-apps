...
1. Memahami dan menerapkan konsep **deployment & ci/cd** dalam GraphQL & Modern API Gateway
...
- **Apa itu deployment & ci/cd** — Definisi dan pentingnya dalam GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Deployment & CI/CD
...
Minggu ini kita telah mempelajari **deployment & ci/cd** dalam GraphQL & Modern API Gateway.

### Poin Penting:
1. Deployment & CI/CD adalah fondasi penting dalam GraphQL & Modern API Gateway
