...
1. Memahami dan menerapkan konsep **arsitektur & pattern** dalam GraphQL & Modern API Gateway
...
- **Apa itu arsitektur & pattern** — Definisi dan pentingnya dalam GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Arsitektur & Pattern
...
Minggu ini kita telah mempelajari **arsitektur & pattern** dalam GraphQL & Modern API Gateway.

### Poin Penting:
1. Arsitektur & Pattern adalah fondasi penting dalam GraphQL & Modern API Gateway
