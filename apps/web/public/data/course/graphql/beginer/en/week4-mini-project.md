...
1. Understand and apply **mini project: first application** concepts in GraphQL & Modern API Gateway
...
- **What is mini project: first application** — Definition and importance in GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Mini Project: First Application
...
This week we learned about **mini project: first application** in GraphQL & Modern API Gateway.

### Key Points:
1. Mini Project: First Application is an important foundation in GraphQL & Modern API Gateway
