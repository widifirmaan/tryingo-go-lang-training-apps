...
1. Memahami dan menerapkan konsep **dasar-dasar pemrograman** dalam GraphQL & Modern API Gateway
...
- **Apa itu dasar-dasar pemrograman** — Definisi dan pentingnya dalam GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Dasar-dasar Pemrograman
...
Minggu ini kita telah mempelajari **dasar-dasar pemrograman** dalam GraphQL & Modern API Gateway.

### Poin Penting:
1. Dasar-dasar Pemrograman adalah fondasi penting dalam GraphQL & Modern API Gateway
