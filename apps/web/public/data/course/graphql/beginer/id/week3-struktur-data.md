...
1. Memahami dan menerapkan konsep **struktur data & algoritma dasar** dalam GraphQL & Modern API Gateway
...
- **Apa itu struktur data & algoritma dasar** — Definisi dan pentingnya dalam GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Struktur Data & Algoritma Dasar
...
Minggu ini kita telah mempelajari **struktur data & algoritma dasar** dalam GraphQL & Modern API Gateway.

### Poin Penting:
1. Struktur Data & Algoritma Dasar adalah fondasi penting dalam GraphQL & Modern API Gateway
