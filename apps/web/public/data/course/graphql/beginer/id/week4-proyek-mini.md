...
1. Memahami dan menerapkan konsep **proyek mini: aplikasi pertama** dalam GraphQL & Modern API Gateway
...
- **Apa itu proyek mini: aplikasi pertama** — Definisi dan pentingnya dalam GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Proyek Mini: Aplikasi Pertama
...
Minggu ini kita telah mempelajari **proyek mini: aplikasi pertama** dalam GraphQL & Modern API Gateway.

### Poin Penting:
1. Proyek Mini: Aplikasi Pertama adalah fondasi penting dalam GraphQL & Modern API Gateway
