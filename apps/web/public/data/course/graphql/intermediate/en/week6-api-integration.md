...
1. Understand and apply **api & integration** concepts in GraphQL & Modern API Gateway
...
- **What is api & integration** — Definition and importance in GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — API & Integration
...
This week we learned about **api & integration** in GraphQL & Modern API Gateway.

### Key Points:
1. API & Integration is an important foundation in GraphQL & Modern API Gateway
