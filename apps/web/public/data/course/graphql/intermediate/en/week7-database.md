...
1. Understand and apply **database & storage** concepts in GraphQL & Modern API Gateway
...
- **What is database & storage** — Definition and importance in GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Database & Storage
...
This week we learned about **database & storage** in GraphQL & Modern API Gateway.

### Key Points:
1. Database & Storage is an important foundation in GraphQL & Modern API Gateway
