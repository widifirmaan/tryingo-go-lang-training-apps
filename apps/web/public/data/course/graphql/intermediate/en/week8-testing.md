...
1. Understand and apply **testing & debugging** concepts in GraphQL & Modern API Gateway
...
- **What is testing & debugging** — Definition and importance in GraphQL & Modern API Gateway
...
This week we learned about **testing & debugging** in GraphQL & Modern API Gateway.

### Key Points:
1. Testing & Debugging is an important foundation in GraphQL & Modern API Gateway
