...
1. Understand and apply **microservices & scalability** concepts in GraphQL & Modern API Gateway
...
- **What is microservices & scalability** — Definition and importance in GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Microservices & Scalability
...
This week we learned about **microservices & scalability** in GraphQL & Modern API Gateway.

### Key Points:
1. Microservices & Scalability is an important foundation in GraphQL & Modern API Gateway
