...
1. Understand and apply **devops & monitoring** concepts in GraphQL & Modern API Gateway
...
- **What is devops & monitoring** — Definition and importance in GraphQL & Modern API Gateway
...
This week we learned about **devops & monitoring** in GraphQL & Modern API Gateway.

### Key Points:
1. DevOps & Monitoring is an important foundation in GraphQL & Modern API Gateway
