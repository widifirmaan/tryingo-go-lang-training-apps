...
1. Understand and apply **final project: production app** concepts in GraphQL & Modern API Gateway
...
- **What is final project: production app** — Definition and importance in GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Final Project: Production App
...
This week we learned about **final project: production app** in GraphQL & Modern API Gateway.

### Key Points:
1. Final Project: Production App is an important foundation in GraphQL & Modern API Gateway
