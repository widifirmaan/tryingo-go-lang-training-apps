...
1. Memahami dan menerapkan konsep **microservices & skalabilitas** dalam GraphQL & Modern API Gateway
...
- **Apa itu microservices & skalabilitas** — Definisi dan pentingnya dalam GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — Microservices & Skalabilitas
...
Minggu ini kita telah mempelajari **microservices & skalabilitas** dalam GraphQL & Modern API Gateway.

### Poin Penting:
1. Microservices & Skalabilitas adalah fondasi penting dalam GraphQL & Modern API Gateway
