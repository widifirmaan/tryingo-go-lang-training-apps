...
1. Memahami dan menerapkan konsep **system design & architecture** dalam GraphQL & Modern API Gateway
...
- **Apa itu system design & architecture** — Definisi dan pentingnya dalam GraphQL & Modern API Gateway
...
```
// GraphQL & Modern API Gateway — System Design & Architecture
...
Minggu ini kita telah mempelajari **system design & architecture** dalam GraphQL & Modern API Gateway.

### Poin Penting:
1. System Design & Architecture adalah fondasi penting dalam GraphQL & Modern API Gateway
