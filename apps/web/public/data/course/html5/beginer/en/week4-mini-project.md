...
1. Understand and apply **mini project: first application** concepts in HTML5 & Web Fundamentals
...
- **What is mini project: first application** — Definition and importance in HTML5 & Web Fundamentals
...
```
// HTML5 & Web Fundamentals — Mini Project: First Application
...
This week we learned about **mini project: first application** in HTML5 & Web Fundamentals.

### Key Points:
1. Mini Project: First Application is an important foundation in HTML5 & Web Fundamentals
