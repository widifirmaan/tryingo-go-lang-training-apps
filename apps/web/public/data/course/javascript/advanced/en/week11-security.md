...
1. Understand and apply **application security** concepts in JavaScript ES6+ & Web Engine
...
- **What is application security** — Definition and importance in JavaScript ES6+ & Web Engine
...
```
// JavaScript ES6+ & Web Engine — Application Security
...
This week we learned about **application security** in JavaScript ES6+ & Web Engine.

### Key Points:
1. Application Security is an important foundation in JavaScript ES6+ & Web Engine
