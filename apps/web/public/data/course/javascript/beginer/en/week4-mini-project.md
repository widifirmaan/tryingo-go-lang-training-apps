...
1. Understand and apply **mini project: first application** concepts in JavaScript ES6+ & Web Engine
...
- **What is mini project: first application** — Definition and importance in JavaScript ES6+ & Web Engine
...
```
// JavaScript ES6+ & Web Engine — Mini Project: First Application
...
This week we learned about **mini project: first application** in JavaScript ES6+ & Web Engine.

### Key Points:
1. Mini Project: First Application is an important foundation in JavaScript ES6+ & Web Engine
