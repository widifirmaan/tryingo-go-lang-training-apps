...
1. Memahami dan menerapkan konsep **deployment & ci/cd** dalam Laravel 11 Fullstack Framework
...
- **Apa itu deployment & ci/cd** — Definisi dan pentingnya dalam Laravel 11 Fullstack Framework
...
```
// Laravel 11 Fullstack Framework — Deployment & CI/CD
...
Minggu ini kita telah mempelajari **deployment & ci/cd** dalam Laravel 11 Fullstack Framework.

### Poin Penting:
1. Deployment & CI/CD adalah fondasi penting dalam Laravel 11 Fullstack Framework
