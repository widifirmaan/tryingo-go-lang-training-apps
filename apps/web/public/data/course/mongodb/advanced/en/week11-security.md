...
1. Understand and apply **application security** concepts in MongoDB NoSQL & Aggregation
...
- **What is application security** — Definition and importance in MongoDB NoSQL & Aggregation
...
```
// MongoDB NoSQL & Aggregation — Application Security
...
This week we learned about **application security** in MongoDB NoSQL & Aggregation.

### Key Points:
1. Application Security is an important foundation in MongoDB NoSQL & Aggregation
