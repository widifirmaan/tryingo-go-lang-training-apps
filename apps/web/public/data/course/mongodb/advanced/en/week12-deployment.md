...
1. Understand and apply **deployment & ci/cd** concepts in MongoDB NoSQL & Aggregation
...
- **What is deployment & ci/cd** — Definition and importance in MongoDB NoSQL & Aggregation
...
This week we learned about **deployment & ci/cd** in MongoDB NoSQL & Aggregation.

### Key Points:
1. Deployment & CI/CD is an important foundation in MongoDB NoSQL & Aggregation
