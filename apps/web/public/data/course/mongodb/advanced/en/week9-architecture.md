...
1. Understand and apply **architecture & patterns** concepts in MongoDB NoSQL & Aggregation
...
- **What is architecture & patterns** — Definition and importance in MongoDB NoSQL & Aggregation
...
```
// MongoDB NoSQL & Aggregation — Architecture & Patterns
...
This week we learned about **architecture & patterns** in MongoDB NoSQL & Aggregation.

### Key Points:
1. Architecture & Patterns is an important foundation in MongoDB NoSQL & Aggregation
