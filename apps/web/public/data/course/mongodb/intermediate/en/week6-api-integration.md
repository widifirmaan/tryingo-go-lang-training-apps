...
1. Understand and apply **api & integration** concepts in MongoDB NoSQL & Aggregation
...
- **What is api & integration** — Definition and importance in MongoDB NoSQL & Aggregation
...
```
// MongoDB NoSQL & Aggregation — API & Integration
...
This week we learned about **api & integration** in MongoDB NoSQL & Aggregation.

### Key Points:
1. API & Integration is an important foundation in MongoDB NoSQL & Aggregation
