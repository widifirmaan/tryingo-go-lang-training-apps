...
1. Understand and apply **database & storage** concepts in MongoDB NoSQL & Aggregation
...
- **What is database & storage** — Definition and importance in MongoDB NoSQL & Aggregation
...
```
// MongoDB NoSQL & Aggregation — Database & Storage
...
This week we learned about **database & storage** in MongoDB NoSQL & Aggregation.

### Key Points:
1. Database & Storage is an important foundation in MongoDB NoSQL & Aggregation
