...
1. Understand and apply **microservices & scalability** concepts in MongoDB NoSQL & Aggregation
...
- **What is microservices & scalability** — Definition and importance in MongoDB NoSQL & Aggregation
...
```
// MongoDB NoSQL & Aggregation — Microservices & Scalability
...
This week we learned about **microservices & scalability** in MongoDB NoSQL & Aggregation.

### Key Points:
1. Microservices & Scalability is an important foundation in MongoDB NoSQL & Aggregation
