...
1. Understand and apply **application security** concepts in MySQL 8 Relational Database
...
- **What is application security** — Definition and importance in MySQL 8 Relational Database
...
```
// MySQL 8 Relational Database — Application Security
...
This week we learned about **application security** in MySQL 8 Relational Database.

### Key Points:
1. Application Security is an important foundation in MySQL 8 Relational Database
