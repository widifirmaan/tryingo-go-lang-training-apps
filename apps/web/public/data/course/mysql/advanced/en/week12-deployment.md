...
1. Understand and apply **deployment & ci/cd** concepts in MySQL 8 Relational Database
...
- **What is deployment & ci/cd** — Definition and importance in MySQL 8 Relational Database
...
This week we learned about **deployment & ci/cd** in MySQL 8 Relational Database.

### Key Points:
1. Deployment & CI/CD is an important foundation in MySQL 8 Relational Database
