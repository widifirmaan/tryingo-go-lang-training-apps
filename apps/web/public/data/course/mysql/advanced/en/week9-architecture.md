...
1. Understand and apply **architecture & patterns** concepts in MySQL 8 Relational Database
...
- **What is architecture & patterns** — Definition and importance in MySQL 8 Relational Database
...
```
// MySQL 8 Relational Database — Architecture & Patterns
...
This week we learned about **architecture & patterns** in MySQL 8 Relational Database.

### Key Points:
1. Architecture & Patterns is an important foundation in MySQL 8 Relational Database
