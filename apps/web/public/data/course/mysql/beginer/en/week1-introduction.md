...
1. Understand and apply **introduction & environment setup** concepts in MySQL 8 Relational Database
...
- **What is introduction & environment setup** — Definition and importance in MySQL 8 Relational Database
...
```
// MySQL 8 Relational Database — Introduction & Environment Setup
...
This week we learned about **introduction & environment setup** in MySQL 8 Relational Database.

### Key Points:
1. Introduction & Environment Setup is an important foundation in MySQL 8 Relational Database
