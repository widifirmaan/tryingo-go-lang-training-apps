...
1. Understand and apply **mini project: first application** concepts in MySQL 8 Relational Database
...
- **What is mini project: first application** — Definition and importance in MySQL 8 Relational Database
...
```
// MySQL 8 Relational Database — Mini Project: First Application
...
This week we learned about **mini project: first application** in MySQL 8 Relational Database.

### Key Points:
1. Mini Project: First Application is an important foundation in MySQL 8 Relational Database
