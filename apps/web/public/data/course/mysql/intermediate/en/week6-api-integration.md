...
1. Understand and apply **api & integration** concepts in MySQL 8 Relational Database
...
- **What is api & integration** — Definition and importance in MySQL 8 Relational Database
...
```
// MySQL 8 Relational Database — API & Integration
...
This week we learned about **api & integration** in MySQL 8 Relational Database.

### Key Points:
1. API & Integration is an important foundation in MySQL 8 Relational Database
