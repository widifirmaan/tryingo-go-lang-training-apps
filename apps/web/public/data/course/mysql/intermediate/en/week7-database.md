...
1. Understand and apply **database & storage** concepts in MySQL 8 Relational Database
...
- **What is database & storage** — Definition and importance in MySQL 8 Relational Database
...
```
// MySQL 8 Relational Database — Database & Storage
...
This week we learned about **database & storage** in MySQL 8 Relational Database.

### Key Points:
1. Database & Storage is an important foundation in MySQL 8 Relational Database
