...
1. Memahami dan menerapkan konsep **database & penyimpanan** dalam MySQL 8 Relational Database
...
- **Apa itu database & penyimpanan** — Definisi dan pentingnya dalam MySQL 8 Relational Database
...
```
// MySQL 8 Relational Database — Database & Penyimpanan
...
Minggu ini kita telah mempelajari **database & penyimpanan** dalam MySQL 8 Relational Database.

### Poin Penting:
1. Database & Penyimpanan adalah fondasi penting dalam MySQL 8 Relational Database
