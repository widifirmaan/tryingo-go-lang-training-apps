...
1. Understand and apply **microservices & scalability** concepts in MySQL 8 Relational Database
...
- **What is microservices & scalability** — Definition and importance in MySQL 8 Relational Database
...
```
// MySQL 8 Relational Database — Microservices & Scalability
...
This week we learned about **microservices & scalability** in MySQL 8 Relational Database.

### Key Points:
1. Microservices & Scalability is an important foundation in MySQL 8 Relational Database
