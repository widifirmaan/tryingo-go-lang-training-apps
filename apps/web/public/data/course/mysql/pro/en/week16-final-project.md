...
1. Understand and apply **final project: production app** concepts in MySQL 8 Relational Database
...
- **What is final project: production app** — Definition and importance in MySQL 8 Relational Database
...
```
// MySQL 8 Relational Database — Final Project: Production App
...
This week we learned about **final project: production app** in MySQL 8 Relational Database.

### Key Points:
1. Final Project: Production App is an important foundation in MySQL 8 Relational Database
