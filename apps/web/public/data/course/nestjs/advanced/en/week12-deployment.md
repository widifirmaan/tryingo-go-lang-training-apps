...
1. Understand and apply **deployment & ci/cd** concepts in NestJS Enterprise Node.js API
...
- **What is deployment & ci/cd** — Definition and importance in NestJS Enterprise Node.js API
...
This week we learned about **deployment & ci/cd** in NestJS Enterprise Node.js API.

### Key Points:
1. Deployment & CI/CD is an important foundation in NestJS Enterprise Node.js API
