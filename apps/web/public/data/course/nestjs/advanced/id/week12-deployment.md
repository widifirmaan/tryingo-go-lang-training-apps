...
1. Memahami dan menerapkan konsep **deployment & ci/cd** dalam NestJS Enterprise Node.js API
...
- **Apa itu deployment & ci/cd** — Definisi dan pentingnya dalam NestJS Enterprise Node.js API
...
```
// NestJS Enterprise Node.js API — Deployment & CI/CD
...
Minggu ini kita telah mempelajari **deployment & ci/cd** dalam NestJS Enterprise Node.js API.

### Poin Penting:
1. Deployment & CI/CD adalah fondasi penting dalam NestJS Enterprise Node.js API
