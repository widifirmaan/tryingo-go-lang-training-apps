...
1. Understand and apply **microservices & scalability** concepts in NestJS Enterprise Node.js API
...
- **What is microservices & scalability** — Definition and importance in NestJS Enterprise Node.js API
...
```
// NestJS Enterprise Node.js API — Microservices & Scalability
...
This week we learned about **microservices & scalability** in NestJS Enterprise Node.js API.

### Key Points:
1. Microservices & Scalability is an important foundation in NestJS Enterprise Node.js API
