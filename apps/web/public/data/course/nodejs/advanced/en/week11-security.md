...
1. Understand and apply **application security** concepts in Node.js & Express REST API
...
- **What is application security** — Definition and importance in Node.js & Express REST API
...
```
// Node.js & Express REST API — Application Security
...
This week we learned about **application security** in Node.js & Express REST API.

### Key Points:
1. Application Security is an important foundation in Node.js & Express REST API
