...
1. Understand and apply **deployment & ci/cd** concepts in Node.js & Express REST API
...
- **What is deployment & ci/cd** — Definition and importance in Node.js & Express REST API
...
This week we learned about **deployment & ci/cd** in Node.js & Express REST API.

### Key Points:
1. Deployment & CI/CD is an important foundation in Node.js & Express REST API
