...
1. Understand and apply **architecture & patterns** concepts in Node.js & Express REST API
...
- **What is architecture & patterns** — Definition and importance in Node.js & Express REST API
...
```
// Node.js & Express REST API — Architecture & Patterns
...
This week we learned about **architecture & patterns** in Node.js & Express REST API.

### Key Points:
1. Architecture & Patterns is an important foundation in Node.js & Express REST API
