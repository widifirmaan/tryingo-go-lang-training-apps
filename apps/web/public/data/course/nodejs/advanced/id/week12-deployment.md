...
1. Memahami dan menerapkan konsep **deployment & ci/cd** dalam Node.js & Express REST API
...
- **Apa itu deployment & ci/cd** — Definisi dan pentingnya dalam Node.js & Express REST API
...
```
// Node.js & Express REST API — Deployment & CI/CD
...
Minggu ini kita telah mempelajari **deployment & ci/cd** dalam Node.js & Express REST API.

### Poin Penting:
1. Deployment & CI/CD adalah fondasi penting dalam Node.js & Express REST API
