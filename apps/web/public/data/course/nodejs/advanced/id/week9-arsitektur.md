...
1. Memahami dan menerapkan konsep **arsitektur & pattern** dalam Node.js & Express REST API
...
- **Apa itu arsitektur & pattern** — Definisi dan pentingnya dalam Node.js & Express REST API
...
```
// Node.js & Express REST API — Arsitektur & Pattern
...
Minggu ini kita telah mempelajari **arsitektur & pattern** dalam Node.js & Express REST API.

### Poin Penting:
1. Arsitektur & Pattern adalah fondasi penting dalam Node.js & Express REST API
