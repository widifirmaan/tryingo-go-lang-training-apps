...
1. Understand and apply **introduction & environment setup** concepts in Node.js & Express REST API
...
- **What is introduction & environment setup** — Definition and importance in Node.js & Express REST API
...
```
// Node.js & Express REST API — Introduction & Environment Setup
...
This week we learned about **introduction & environment setup** in Node.js & Express REST API.

### Key Points:
1. Introduction & Environment Setup is an important foundation in Node.js & Express REST API
