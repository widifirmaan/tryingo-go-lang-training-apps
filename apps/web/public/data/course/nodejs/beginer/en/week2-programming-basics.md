...
1. Understand and apply **programming fundamentals** concepts in Node.js & Express REST API
...
- **What is programming fundamentals** — Definition and importance in Node.js & Express REST API
...
```
// Node.js & Express REST API — Programming Fundamentals
...
This week we learned about **programming fundamentals** in Node.js & Express REST API.

### Key Points:
1. Programming Fundamentals is an important foundation in Node.js & Express REST API
