...
1. Understand and apply **mini project: first application** concepts in Node.js & Express REST API
...
- **What is mini project: first application** — Definition and importance in Node.js & Express REST API
...
```
// Node.js & Express REST API — Mini Project: First Application
...
This week we learned about **mini project: first application** in Node.js & Express REST API.

### Key Points:
1. Mini Project: First Application is an important foundation in Node.js & Express REST API
