...
1. Memahami dan menerapkan konsep **pengenalan & persiapan lingkungan** dalam Node.js & Express REST API
2. Menulis kode Node.js & Express REST API yang bersih dan terstruktur
...
- **Apa itu pengenalan & persiapan lingkungan** — Definisi dan pentingnya dalam Node.js & Express REST API
...
```
// Node.js & Express REST API — Pengenalan & Persiapan Lingkungan
...
Minggu ini kita telah mempelajari **pengenalan & persiapan lingkungan** dalam Node.js & Express REST API.

### Poin Penting:
1. Pengenalan & Persiapan Lingkungan adalah fondasi penting dalam Node.js & Express REST API
...
- Dokumentasi resmi Node.js & Express REST API
