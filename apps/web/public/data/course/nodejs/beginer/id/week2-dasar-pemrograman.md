...
1. Memahami dan menerapkan konsep **dasar-dasar pemrograman** dalam Node.js & Express REST API
...
- **Apa itu dasar-dasar pemrograman** — Definisi dan pentingnya dalam Node.js & Express REST API
...
```
// Node.js & Express REST API — Dasar-dasar Pemrograman
...
Minggu ini kita telah mempelajari **dasar-dasar pemrograman** dalam Node.js & Express REST API.

### Poin Penting:
1. Dasar-dasar Pemrograman adalah fondasi penting dalam Node.js & Express REST API
