...
1. Memahami dan menerapkan konsep **struktur data & algoritma dasar** dalam Node.js & Express REST API
...
- **Apa itu struktur data & algoritma dasar** — Definisi dan pentingnya dalam Node.js & Express REST API
...
```
// Node.js & Express REST API — Struktur Data & Algoritma Dasar
...
Minggu ini kita telah mempelajari **struktur data & algoritma dasar** dalam Node.js & Express REST API.

### Poin Penting:
1. Struktur Data & Algoritma Dasar adalah fondasi penting dalam Node.js & Express REST API
