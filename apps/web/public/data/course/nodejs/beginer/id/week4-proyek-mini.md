...
1. Memahami dan menerapkan konsep **proyek mini: aplikasi pertama** dalam Node.js & Express REST API
...
- **Apa itu proyek mini: aplikasi pertama** — Definisi dan pentingnya dalam Node.js & Express REST API
...
```
// Node.js & Express REST API — Proyek Mini: Aplikasi Pertama
...
Minggu ini kita telah mempelajari **proyek mini: aplikasi pertama** dalam Node.js & Express REST API.

### Poin Penting:
1. Proyek Mini: Aplikasi Pertama adalah fondasi penting dalam Node.js & Express REST API
