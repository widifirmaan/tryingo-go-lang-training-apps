...
1. Understand and apply **api & integration** concepts in Node.js & Express REST API
...
- **What is api & integration** — Definition and importance in Node.js & Express REST API
...
```
// Node.js & Express REST API — API & Integration
...
This week we learned about **api & integration** in Node.js & Express REST API.

### Key Points:
1. API & Integration is an important foundation in Node.js & Express REST API
