...
1. Understand and apply **database & storage** concepts in Node.js & Express REST API
...
- **What is database & storage** — Definition and importance in Node.js & Express REST API
...
```
// Node.js & Express REST API — Database & Storage
...
This week we learned about **database & storage** in Node.js & Express REST API.

### Key Points:
1. Database & Storage is an important foundation in Node.js & Express REST API
