...
1. Understand and apply **testing & debugging** concepts in Node.js & Express REST API
...
- **What is testing & debugging** — Definition and importance in Node.js & Express REST API
...
This week we learned about **testing & debugging** in Node.js & Express REST API.

### Key Points:
1. Testing & Debugging is an important foundation in Node.js & Express REST API
