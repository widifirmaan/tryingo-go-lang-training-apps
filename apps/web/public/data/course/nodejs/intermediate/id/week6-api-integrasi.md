...
1. Memahami dan menerapkan konsep **api & integrasi** dalam Node.js & Express REST API
...
- **Apa itu api & integrasi** — Definisi dan pentingnya dalam Node.js & Express REST API
...
```
// Node.js & Express REST API — API & Integrasi
...
Minggu ini kita telah mempelajari **api & integrasi** dalam Node.js & Express REST API.

### Poin Penting:
1. API & Integrasi adalah fondasi penting dalam Node.js & Express REST API
