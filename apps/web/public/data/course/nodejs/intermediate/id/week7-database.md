...
1. Memahami dan menerapkan konsep **database & penyimpanan** dalam Node.js & Express REST API
...
- **Apa itu database & penyimpanan** — Definisi dan pentingnya dalam Node.js & Express REST API
...
```
// Node.js & Express REST API — Database & Penyimpanan
...
Minggu ini kita telah mempelajari **database & penyimpanan** dalam Node.js & Express REST API.

### Poin Penting:
1. Database & Penyimpanan adalah fondasi penting dalam Node.js & Express REST API
