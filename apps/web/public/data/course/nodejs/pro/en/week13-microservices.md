...
1. Understand and apply **microservices & scalability** concepts in Node.js & Express REST API
...
- **What is microservices & scalability** — Definition and importance in Node.js & Express REST API
...
```
// Node.js & Express REST API — Microservices & Scalability
...
This week we learned about **microservices & scalability** in Node.js & Express REST API.

### Key Points:
1. Microservices & Scalability is an important foundation in Node.js & Express REST API
