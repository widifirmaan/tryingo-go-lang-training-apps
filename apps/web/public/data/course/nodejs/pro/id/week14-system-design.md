...
1. Memahami dan menerapkan konsep **system design & architecture** dalam Node.js & Express REST API
...
- **Apa itu system design & architecture** — Definisi dan pentingnya dalam Node.js & Express REST API
...
```
// Node.js & Express REST API — System Design & Architecture
...
Minggu ini kita telah mempelajari **system design & architecture** dalam Node.js & Express REST API.

### Poin Penting:
1. System Design & Architecture adalah fondasi penting dalam Node.js & Express REST API
