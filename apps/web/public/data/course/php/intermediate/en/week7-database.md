...
1. Understand and apply **database & storage** concepts in PHP 8.3 & Modern Backend
...
- **What is database & storage** — Definition and importance in PHP 8.3 & Modern Backend
...
```
// PHP 8.3 & Modern Backend — Database & Storage
...
This week we learned about **database & storage** in PHP 8.3 & Modern Backend.

### Key Points:
1. Database & Storage is an important foundation in PHP 8.3 & Modern Backend
