...
1. Understand and apply **application security** concepts in PostgreSQL & Relational DB Arch
...
- **What is application security** — Definition and importance in PostgreSQL & Relational DB Arch
...
```
// PostgreSQL & Relational DB Arch — Application Security
...
This week we learned about **application security** in PostgreSQL & Relational DB Arch.

### Key Points:
1. Application Security is an important foundation in PostgreSQL & Relational DB Arch
