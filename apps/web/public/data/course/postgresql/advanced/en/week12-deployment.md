...
1. Understand and apply **deployment & ci/cd** concepts in PostgreSQL & Relational DB Arch
...
- **What is deployment & ci/cd** — Definition and importance in PostgreSQL & Relational DB Arch
...
This week we learned about **deployment & ci/cd** in PostgreSQL & Relational DB Arch.

### Key Points:
1. Deployment & CI/CD is an important foundation in PostgreSQL & Relational DB Arch
