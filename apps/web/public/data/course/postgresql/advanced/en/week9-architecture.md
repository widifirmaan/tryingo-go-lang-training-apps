...
1. Understand and apply **architecture & patterns** concepts in PostgreSQL & Relational DB Arch
...
- **What is architecture & patterns** — Definition and importance in PostgreSQL & Relational DB Arch
...
```
// PostgreSQL & Relational DB Arch — Architecture & Patterns
...
This week we learned about **architecture & patterns** in PostgreSQL & Relational DB Arch.

### Key Points:
1. Architecture & Patterns is an important foundation in PostgreSQL & Relational DB Arch
