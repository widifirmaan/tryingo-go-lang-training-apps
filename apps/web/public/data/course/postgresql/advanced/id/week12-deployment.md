...
1. Memahami dan menerapkan konsep **deployment & ci/cd** dalam PostgreSQL & Relational DB Arch
...
- **Apa itu deployment & ci/cd** — Definisi dan pentingnya dalam PostgreSQL & Relational DB Arch
...
```
// PostgreSQL & Relational DB Arch — Deployment & CI/CD
...
Minggu ini kita telah mempelajari **deployment & ci/cd** dalam PostgreSQL & Relational DB Arch.

### Poin Penting:
1. Deployment & CI/CD adalah fondasi penting dalam PostgreSQL & Relational DB Arch
