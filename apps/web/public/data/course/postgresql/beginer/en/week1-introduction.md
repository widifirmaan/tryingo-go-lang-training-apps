...
1. Understand and apply **introduction & environment setup** concepts in PostgreSQL & Relational DB Arch
...
- **What is introduction & environment setup** — Definition and importance in PostgreSQL & Relational DB Arch
...
```
// PostgreSQL & Relational DB Arch — Introduction & Environment Setup
...
This week we learned about **introduction & environment setup** in PostgreSQL & Relational DB Arch.

### Key Points:
1. Introduction & Environment Setup is an important foundation in PostgreSQL & Relational DB Arch
