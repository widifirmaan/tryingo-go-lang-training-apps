...
1. Understand and apply **mini project: first application** concepts in PostgreSQL & Relational DB Arch
...
- **What is mini project: first application** — Definition and importance in PostgreSQL & Relational DB Arch
...
```
// PostgreSQL & Relational DB Arch — Mini Project: First Application
...
This week we learned about **mini project: first application** in PostgreSQL & Relational DB Arch.

### Key Points:
1. Mini Project: First Application is an important foundation in PostgreSQL & Relational DB Arch
