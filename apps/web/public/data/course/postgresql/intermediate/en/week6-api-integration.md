...
1. Understand and apply **api & integration** concepts in PostgreSQL & Relational DB Arch
...
- **What is api & integration** — Definition and importance in PostgreSQL & Relational DB Arch
...
```
// PostgreSQL & Relational DB Arch — API & Integration
...
This week we learned about **api & integration** in PostgreSQL & Relational DB Arch.

### Key Points:
1. API & Integration is an important foundation in PostgreSQL & Relational DB Arch
