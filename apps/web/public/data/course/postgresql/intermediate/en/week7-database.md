...
1. Understand and apply **database & storage** concepts in PostgreSQL & Relational DB Arch
...
- **What is database & storage** — Definition and importance in PostgreSQL & Relational DB Arch
...
```
// PostgreSQL & Relational DB Arch — Database & Storage
...
This week we learned about **database & storage** in PostgreSQL & Relational DB Arch.

### Key Points:
1. Database & Storage is an important foundation in PostgreSQL & Relational DB Arch
