...
1. Understand and apply **microservices & scalability** concepts in PostgreSQL & Relational DB Arch
...
- **What is microservices & scalability** — Definition and importance in PostgreSQL & Relational DB Arch
...
```
// PostgreSQL & Relational DB Arch — Microservices & Scalability
...
This week we learned about **microservices & scalability** in PostgreSQL & Relational DB Arch.

### Key Points:
1. Microservices & Scalability is an important foundation in PostgreSQL & Relational DB Arch
