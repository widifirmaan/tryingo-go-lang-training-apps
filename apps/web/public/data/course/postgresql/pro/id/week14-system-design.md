...
1. Memahami dan menerapkan konsep **system design & architecture** dalam PostgreSQL & Relational DB Arch
...
- **Apa itu system design & architecture** — Definisi dan pentingnya dalam PostgreSQL & Relational DB Arch
...
```
// PostgreSQL & Relational DB Arch — System Design & Architecture
...
Minggu ini kita telah mempelajari **system design & architecture** dalam PostgreSQL & Relational DB Arch.

### Poin Penting:
1. System Design & Architecture adalah fondasi penting dalam PostgreSQL & Relational DB Arch
