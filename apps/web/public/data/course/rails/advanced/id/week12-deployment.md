...
1. Memahami dan menerapkan konsep **deployment & ci/cd** dalam Ruby on Rails 7 Convention Web
...
- **Apa itu deployment & ci/cd** — Definisi dan pentingnya dalam Ruby on Rails 7 Convention Web
...
```
// Ruby on Rails 7 Convention Web — Deployment & CI/CD
...
Minggu ini kita telah mempelajari **deployment & ci/cd** dalam Ruby on Rails 7 Convention Web.

### Poin Penting:
1. Deployment & CI/CD adalah fondasi penting dalam Ruby on Rails 7 Convention Web
