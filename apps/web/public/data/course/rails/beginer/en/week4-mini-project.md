...
1. Understand and apply **mini project: first application** concepts in Ruby on Rails 7 Convention Web
...
- **What is mini project: first application** — Definition and importance in Ruby on Rails 7 Convention Web
...
```
// Ruby on Rails 7 Convention Web — Mini Project: First Application
...
This week we learned about **mini project: first application** in Ruby on Rails 7 Convention Web.

### Key Points:
1. Mini Project: First Application is an important foundation in Ruby on Rails 7 Convention Web
