...
1. Memahami dan menerapkan konsep **proyek mini: aplikasi pertama** dalam Ruby on Rails 7 Convention Web
...
- **Apa itu proyek mini: aplikasi pertama** — Definisi dan pentingnya dalam Ruby on Rails 7 Convention Web
...
```
// Ruby on Rails 7 Convention Web — Proyek Mini: Aplikasi Pertama
...
Minggu ini kita telah mempelajari **proyek mini: aplikasi pertama** dalam Ruby on Rails 7 Convention Web.

### Poin Penting:
1. Proyek Mini: Aplikasi Pertama adalah fondasi penting dalam Ruby on Rails 7 Convention Web
