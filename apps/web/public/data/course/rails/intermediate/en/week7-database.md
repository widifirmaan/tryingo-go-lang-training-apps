...
1. Understand and apply **database & storage** concepts in Ruby on Rails 7 Convention Web
...
- **What is database & storage** — Definition and importance in Ruby on Rails 7 Convention Web
...
```
// Ruby on Rails 7 Convention Web — Database & Storage
...
This week we learned about **database & storage** in Ruby on Rails 7 Convention Web.

### Key Points:
1. Database & Storage is an important foundation in Ruby on Rails 7 Convention Web
