...
1. Memahami dan menerapkan konsep **api & integrasi** dalam Ruby on Rails 7 Convention Web
...
- **Apa itu api & integrasi** — Definisi dan pentingnya dalam Ruby on Rails 7 Convention Web
...
```
// Ruby on Rails 7 Convention Web — API & Integrasi
...
Minggu ini kita telah mempelajari **api & integrasi** dalam Ruby on Rails 7 Convention Web.

### Poin Penting:
1. API & Integrasi adalah fondasi penting dalam Ruby on Rails 7 Convention Web
