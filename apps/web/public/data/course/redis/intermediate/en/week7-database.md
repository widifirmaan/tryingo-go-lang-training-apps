...
1. Understand and apply **database & storage** concepts in Redis In-Memory Cache & PubSub
...
- **What is database & storage** — Definition and importance in Redis In-Memory Cache & PubSub
...
```
// Redis In-Memory Cache & PubSub — Database & Storage
...
This week we learned about **database & storage** in Redis In-Memory Cache & PubSub.

### Key Points:
1. Database & Storage is an important foundation in Redis In-Memory Cache & PubSub
