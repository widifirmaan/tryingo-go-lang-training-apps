...
1. Understand and apply **system design & architecture** concepts in Redis In-Memory Cache & PubSub
...
- **What is system design & architecture** — Definition and importance in Redis In-Memory Cache & PubSub
...
This week we learned about **system design & architecture** in Redis In-Memory Cache & PubSub.

### Key Points:
1. System Design & Architecture is an important foundation in Redis In-Memory Cache & PubSub
