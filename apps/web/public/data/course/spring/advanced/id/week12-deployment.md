...
1. Memahami dan menerapkan konsep **deployment & ci/cd** dalam Java Spring Boot 3 Enterprise API
...
### 1. Pengantar Deployment & CI/CD

Konsep fundamental deployment & ci/cd sangat penting untuk dikuasai. Pada sesi ini, kita akan membahas:

- **Apa itu deployment & ci/cd** — Definisi dan pentingnya dalam Java Spring Boot 3 Enterprise API
...
```
// Java Spring Boot 3 Enterprise API — Deployment & CI/CD
...
Minggu ini kita telah mempelajari **deployment & ci/cd** dalam Java Spring Boot 3 Enterprise API.

### Poin Penting:
1. Deployment & CI/CD adalah fondasi penting dalam Java Spring Boot 3 Enterprise API
...
**Selamat belajar!** Lanjutkan ke Minggu 13 setelah menguasai materi ini. 🚀
