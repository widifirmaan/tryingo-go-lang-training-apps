...
1. Understand and apply **deployment & ci/cd** concepts in TypeScript Type-Safe Architecture
...
- **What is deployment & ci/cd** — Definition and importance in TypeScript Type-Safe Architecture
...
This week we learned about **deployment & ci/cd** in TypeScript Type-Safe Architecture.

### Key Points:
1. Deployment & CI/CD is an important foundation in TypeScript Type-Safe Architecture
