...
1. Memahami dan menerapkan konsep **deployment & ci/cd** dalam Vue 3 Composition API & Pinia
...
- **Apa itu deployment & ci/cd** — Definisi dan pentingnya dalam Vue 3 Composition API & Pinia
...
```
// Vue 3 Composition API & Pinia — Deployment & CI/CD
...
Minggu ini kita telah mempelajari **deployment & ci/cd** dalam Vue 3 Composition API & Pinia.

### Poin Penting:
1. Deployment & CI/CD adalah fondasi penting dalam Vue 3 Composition API & Pinia
