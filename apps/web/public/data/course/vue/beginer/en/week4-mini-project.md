...
1. Understand and apply **mini project: first application** concepts in Vue 3 Composition API & Pinia
...
- **What is mini project: first application** — Definition and importance in Vue 3 Composition API & Pinia
...
```
// Vue 3 Composition API & Pinia — Mini Project: First Application
...
This week we learned about **mini project: first application** in Vue 3 Composition API & Pinia.

### Key Points:
1. Mini Project: First Application is an important foundation in Vue 3 Composition API & Pinia
