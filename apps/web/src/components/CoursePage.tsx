...
export const CoursePage: React.FC<CoursePageProps> = ({ trackId, lang, onBack, onOpenPlayground, initialLevel, initialWeek, onNavigate }) => {
  ...
  const isStackBlitz = slug === 'nextjs' || slug === 'react' || slug === 'python' || slug === 'vue' || slug === 'nodejs' || slug === 'nestjs' || slug === 'django' || slug === 'laravel' || slug === 'php';
  const isDocker = slug === 'docker';
  const stackBlitzMainFile = slug === 'nextjs' ? 'app/page.tsx' : slug === 'python' ? 'index.py' : slug === 'vue' ? 'src/App.vue' : slug === 'nodejs' ? 'server.js' : slug === 'nestjs' ? 'src/main.ts' : slug === 'django' ? 'manage.py' : slug === 'laravel' ? 'artisan' : slug === 'php' ? 'index.php' : 'src/App.jsx';
  const stackBlitzTitle = slug === 'nextjs' ? 'Next.js Lesson' : slug === 'python' ? 'Python Lesson' : slug === 'vue' ? 'Vue Lesson' : slug === 'nodejs' ? 'Node.js Lesson' : slug === 'nestjs' ? 'NestJS Lesson' : slug === 'django' ? 'Django Lesson' : slug === 'laravel' ? 'Laravel Lesson' : slug === 'php' ? 'PHP Lesson' : 'React Lesson';
